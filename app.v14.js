...
function setupEventListeners() {
    ...
    els.inputModeSelect.addEventListener('change', (e) => {
        ...
        if (mode === 'piano') {
            ...
            els.guitarFretboard.classList.add('hidden');
            els.showNotesContainer.style.display = 'none';
        } else {
            els.pianoKeyboard.classList.add('hidden');
            els.guitarFretboard.classList.remove('hidden');
            els.showNotesContainer.style.display = 'inline-flex';
        }
        resetSelection();
    });
    ...
    els.showNotesCheckbox.addEventListener('change', (e) => {
        if (e.target.checked) {
            els.guitarFretboard.classList.remove('hide-notes');
        } else {
            els.guitarFretboard.classList.add('hide-notes');
        }
    });
